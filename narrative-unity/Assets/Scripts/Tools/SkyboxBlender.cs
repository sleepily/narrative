...
public class SkyboxBlender : MonoBehaviour {
    ...
    [SerializeField] bool enableBlend = false;

    [SerializeField] public float lerpFactor = .1f;
    [SerializeField] float targetBlend = 0f;

    [SerializeField] int blendSteps = 5;
    [SerializeField] int currentBlendStep = 0;
    ...
    public void AllowBlend(bool allowBlend)
    {
        enableBlend = allowBlend;
